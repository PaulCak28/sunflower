...
val md_theme_light_primary = Color(0xffbca37f)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xffbca37f)
val md_theme_light_onPrimaryContainer = Color(0xFF062100)
val md_theme_light_secondary = Color(0xFF55624C)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xffead7bb)
...
val md_theme_light_surfaceTint = Color(0xffbca37f)
...
val md_theme_dark_onPrimaryContainer = Color(0xffbca37f)
...
val md_theme_dark_onSecondaryContainer = Color(0xffead7bb)
